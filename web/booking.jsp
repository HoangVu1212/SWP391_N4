                            ...
                            <div class="datetime-selection">
                                <div class="calendar-container" style="max-height: fit-content">
                                    ...
                                    <input type="date" id="appointmentDate" name="appointmentDate"
                                           value="${today}" required onchange="getAvailableTimes()">
...
<script>
    ...
    async function getAvailableTimes() {
        console.log("calling getAvailableTimes()");
...
<script>
    ...
    function updateSummary() {
        ...
        document.getElementById('selectedServices').value = selectedService?.value;
