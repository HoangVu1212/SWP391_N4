                    ...
                    <% Cookie[] cookies=request.getCookies(); boolean hasVisited=false; if (cookies !=null) { for
                        ...
                        <section class="hero">
                            <div class="hero-text" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <button class="cta-button" onclick="window.location='/SmartSpa1.0/booking'">Book Your Experience</button>
                            </div>
                        </section>
                        ...
                        <footer>
                            <div class="footer-content">
                                ...
                                <button class="cta-button" onclick="window.location='/SmartSpa1.0/booking'"">Book Now</button>
                            </div>
