...
//        }
  ...
  for (Feedback fb : feedbackList) {
            ...
            System.out.println("Customer Name: " + fb.getCustomer().getName());
            System.out.println("Service Name: " + fb.getService().getName());
//            System.out.println("Star Rating: " + fb.getStarRating());
            System.out.println("Response Feedback: " + fb.getResponseFeedback());
            System.out.println("-------------");
        }
    }
